...
public unsafe struct MenuDialog
{
    ...
    /// <summary>
    /// <code>Offset: 0x00475810
    /// UIElement* __thiscall MenuDialog::DynamicCast(MenuDialog*,unsigned int)</code>
    /// </summary>
    public ACBindings.Internal.UIElement* DynamicCast(uint i_eType) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.MenuDialog, uint, ACBindings.Internal.UIElement*>)0x00475810)(ref this, i_eType);

    /// <summary>
    /// <code>Offset: 0x004758B0
    /// void __thiscall MenuDialog::SetData(MenuDialog*,const PropertyCollection*)</code>
    /// </summary>
    public void SetData(ACBindings.Internal.PropertyCollection* i_cData) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.MenuDialog, ACBindings.Internal.PropertyCollection*, void>)0x004758B0)(ref this, i_cData);

    /// <summary>
    /// <code>Offset: 0x00475BA0
    /// UIElementMessageListenResult __thiscall MenuDialog::ListenToElementMessage(MenuDialog*,const UIElementMessageInfo*)</code>
    /// </summary>
    public ACBindings.Internal.UIElementMessageListenResult ListenToElementMessage(ACBindings.Internal.UIElementMessageInfo* i_rMsg) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.MenuDialog, ACBindings.Internal.UIElementMessageInfo*, ACBindings.Internal.UIElementMessageListenResult>)0x00475BA0)(ref this, i_rMsg);

    /// <summary>
    /// <code>Offset: 0x00475CA0
    /// void __thiscall MenuDialog::CancelDialog(MenuDialog*)</code>
    /// </summary>
    public void CancelDialog() => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.MenuDialog, void>)0x00475CA0)(ref this);

    /// <summary>
    /// <code>Offset: 0x00680670
    /// int __thiscall MenuDialog::GetUIElementType(SetOmegaHook*)</code>
    /// </summary>
    public int GetUIElementType() => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.MenuDialog, int>)0x00680670)(ref this);
}
