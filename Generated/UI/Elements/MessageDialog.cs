...
/// <summary>Provides a dialog window for displaying brief messages within the user interface.</summary>
/// <remarks>Inherits from Dialog and participates in UI element casting and message handling.</remarks>
public unsafe struct MessageDialog
{
    ...
    /// <summary>Attempts to cast this MessageDialog instance to a specified type based on its numeric type identifier.
    /// <code>Offset: 0x00475610
    /// UIElement* __thiscall MessageDialog::DynamicCast(MessageDialog*,unsigned int)</code>
    /// </summary>
    /// <param name="i_eType">Numeric identifier of the desired type (e.g., 23 for UIElement, 3 for MessageDialog).</param>
    /// <returns>Pointer to the requested type if the conversion is valid; otherwise nullptr.</returns>
    ...
    /// <summary>Sets dialog data from a PropertyCollection, updating internal properties and refreshing UI elements such as the message text field.
    /// <code>Offset: 0x004756F0
    /// void __thiscall MessageDialog::SetData(MessageDialog*,const PropertyCollection*)</code>
    /// </summary>
    /// <param name="this">The MessageDialog instance whose data is being set.</param>
    /// <param name="i_cData">PropertyCollection containing the new data for the dialog.</param>
    ...
    /// <summary>Returns a constant identifying the UI element type for a MessageDialog.
    /// <code>Offset: 0x00527520
    /// int __thiscall MessageDialog::GetUIElementType(TextureVelocityHook*)</code>
    /// </summary>
    /// <returns>An integer value (23) representing the UI element type.</returns>
