...
// UIOption_CheckboxBitfield
public unsafe struct UIOption_CheckboxBitfield
{
    // Base Classes
    public ACBindings.UIOption_Checkbox BaseClass_UIOption_Checkbox; // ACBindings.UIOption_Checkbox

    // Child Types
    // UIOption_CheckboxBitfield_vtbl
    public unsafe struct UIOption_CheckboxBitfield_vtbl
    {
        ...
        public System.IntPtr UIOption_CheckboxBitfield_dtor_2a8; // function pointer
    ...
    // Methods
    // UIElement* __thiscall UIOption_CheckboxBitfield::DynamicCast(UIOption_CheckboxBitfield*,unsigned int)
    public ACBindings.UIElement* DynamicCast(uint i_eType) => ((delegate* unmanaged[Thiscall]<ref ACBindings.UIOption_CheckboxBitfield, uint, ACBindings.UIElement*>)0x00486700)(ref this, i_eType);
    // unsigned int __thiscall UIOption_CheckboxBitfield::GetUIElementType(UIOption_CheckboxBitfield*)
    public uint GetUIElementType() => ((delegate* unmanaged[Thiscall]<ref ACBindings.UIOption_CheckboxBitfield, uint>)0x00486770)(ref this);
    // UIElement* __cdecl UIOption_CheckboxBitfield::Create(const LayoutDesc*,const ElementDesc*)
    public static ACBindings.UIElement* Create(ACBindings.LayoutDesc* layout, ACBindings.ElementDesc* full_desc) => ((delegate* unmanaged[Cdecl]<ACBindings.LayoutDesc*, ACBindings.ElementDesc*, ACBindings.UIElement*>)0x00486780)(layout, full_desc);
    // UIElement* __thiscall UIOption_CheckboxBitfield::DynamicCast(unsigned int)
    public ACBindings.UIElement* DynamicCast() => ((delegate* unmanaged[Thiscall]<ref ACBindings.UIOption_CheckboxBitfield, ACBindings.UIElement*>)0x004867E0)(ref this);
    // void __cdecl UIOption_CheckboxBitfield::Register()
    public static void Register() => ((delegate* unmanaged[Cdecl]<void>)0x00486830)();
    // bool __thiscall UIOption_CheckboxBitfield::Apply(UIOption_CheckboxBitfield*,bool)
    public byte Apply(byte userRequested) => ((delegate* unmanaged[Thiscall]<ref ACBindings.UIOption_CheckboxBitfield, byte, byte>)0x00486850)(ref this, userRequested);
    // bool __thiscall UIOption_CheckboxBitfield::GetValue(UIOption_CheckboxBitfield*)
    public byte GetValue() => ((delegate* unmanaged[Thiscall]<ref ACBindings.UIOption_CheckboxBitfield, byte>)0x00486AC0)(ref this);
}
