...
public unsafe struct TextInputDialog
{
    // Base Classes
    public ACBindings.Internal.Dialog BaseClass_Dialog; // ACBindings.Internal.Dialog

    // Child Types
    public unsafe struct TextInputDialog_vtbl
    {
        // Members
    ...
    /// <summary>
    /// <code>Offset: 0x00475210
    /// UIElement* __thiscall TextInputDialog::DynamicCast(TextInputDialog*,unsigned int)</code>
    /// </summary>
    public ACBindings.Internal.UIElement* DynamicCast(uint i_eType) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.TextInputDialog, uint, ACBindings.Internal.UIElement*>)0x00475210)(ref this, i_eType);

    /// <summary>
    /// <code>Offset: 0x004752B0
    /// void __thiscall TextInputDialog::SetData(TextInputDialog*,const PropertyCollection*)</code>
    /// </summary>
    public void SetData(ACBindings.Internal.PropertyCollection* i_cData) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.TextInputDialog, ACBindings.Internal.PropertyCollection*, void>)0x004752B0)(ref this, i_cData);

    /// <summary>
    /// <code>Offset: 0x00475400
    /// UIElementMessageListenResult __thiscall TextInputDialog::ListenToElementMessage(TextInputDialog*,const UIElementMessageInfo*)</code>
    /// </summary>
    public ACBindings.Internal.UIElementMessageListenResult ListenToElementMessage(ACBindings.Internal.UIElementMessageInfo* i_rMsg) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.TextInputDialog, ACBindings.Internal.UIElementMessageInfo*, ACBindings.Internal.UIElementMessageListenResult>)0x00475400)(ref this, i_rMsg);

    /// <summary>
    /// <code>Offset: 0x00475540
    /// void __thiscall TextInputDialog::CancelDialog(TextInputDialog*)</code>
    /// </summary>
    public void CancelDialog() => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.TextInputDialog, void>)0x00475540)(ref this);

    /// <summary>
    /// <code>Offset: 0x005274F0
    /// unsigned int __thiscall TextInputDialog::GetUIElementType(PalSet*)</code>
    /// </summary>
    public uint GetUIElementType() => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.TextInputDialog, uint>)0x005274F0)(ref this);
}
