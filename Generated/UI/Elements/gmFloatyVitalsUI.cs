...
public unsafe struct gmFloatyVitalsUI
{
    ...
    // Methods
    // UIElement* __thiscall gmFloatyVitalsUI::DynamicCast(gmFloatyVitalsUI*,unsigned int)
    public ACBindings.UIElement* DynamicCast(uint i_eType) => ((delegate* unmanaged[Thiscall]<ref ACBindings.gmFloatyVitalsUI, uint, ACBindings.UIElement*>)0x004CF8C0)(ref this, i_eType);
    // void __cdecl gmFloatyVitalsUI::Register()
    public static void Register() => ((delegate* unmanaged[Cdecl]<void>)0x004CF9A0)();
    // void __thiscall gmFloatyVitalsUI::PostInit(gmFloatyVitalsUI*)
    public void PostInit() => ((delegate* unmanaged[Thiscall]<ref ACBindings.gmFloatyVitalsUI, void>)0x004CF9C0)(ref this);
    // void __thiscall gmFloatyVitalsUI::UpdateLockedStatus(gmFloatyVitalsUI*)
    public void UpdateLockedStatus() => ((delegate* unmanaged[Thiscall]<ref ACBindings.gmFloatyVitalsUI, void>)0x004D1000)(ref this);
}
