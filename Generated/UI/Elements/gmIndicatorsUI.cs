...
public unsafe struct gmIndicatorsUI : System.IDisposable
{
    // Base Classes
    ...
    // Child Types
    public unsafe struct gmIndicatorsUI_vtbl
    {
        // Members
    ...
    public gmIndicatorsUI(ACBindings.Internal.LayoutDesc* layout, ACBindings.Internal.ElementDesc* full_desc) {
    ...
    /// <summary>
    /// <code>Offset: 0x004C0620
    /// void __thiscall gmIndicatorsUI::gmIndicatorsUI(gmIndicatorsUI*,const LayoutDesc*,const ElementDesc*)</code>
    /// </summary>
    public void _ConstructorInternal(ACBindings.Internal.LayoutDesc* layout, ACBindings.Internal.ElementDesc* full_desc) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.gmIndicatorsUI, ACBindings.Internal.LayoutDesc*, ACBindings.Internal.ElementDesc*, void>)0x004C0620)(ref this, layout, full_desc);

    /// <summary>
    /// <code>Offset: 0x004C0660
    /// UIElement* __thiscall gmIndicatorsUI::DynamicCast(gmIndicatorsUI*,unsigned int)</code>
    /// </summary>
    public ACBindings.Internal.UIElement* DynamicCast(uint i_eType) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.gmIndicatorsUI, uint, ACBindings.Internal.UIElement*>)0x004C0660)(ref this, i_eType);

    /// <summary>
    /// <code>Offset: 0x004C0690
    /// void __thiscall gmIndicatorsUI::~gmIndicatorsUI(gmIndicatorsUI*)</code>
    /// </summary>
    public void _DestructorInternal() => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.gmIndicatorsUI, void>)0x004C0690)(ref this);

    /// <summary>
    /// <code>Offset: 0x004C06C0
    /// UIElement* __cdecl gmIndicatorsUI::Create(const LayoutDesc*,const ElementDesc*)</code>
    /// </summary>
    public static ACBindings.Internal.UIElement* Create(ACBindings.Internal.LayoutDesc* layout, ACBindings.Internal.ElementDesc* full_desc) => ((delegate* unmanaged[Cdecl]<ACBindings.Internal.LayoutDesc*, ACBindings.Internal.ElementDesc*, ACBindings.Internal.UIElement*>)0x004C06C0)(layout, full_desc);

    /// <summary>
    /// <code>Offset: 0x004C0710
    /// UIElementMessageListenResult __thiscall gmIndicatorsUI::ListenToElementMessage(gmIndicatorsUI*,const UIElementMessageInfo*)</code>
    /// </summary>
    public ACBindings.Internal.UIElementMessageListenResult ListenToElementMessage(ACBindings.Internal.UIElementMessageInfo* i_rMsg) => ((delegate* unmanaged[Thiscall]<ref ACBindings.Internal.gmIndicatorsUI, ACBindings.Internal.UIElementMessageInfo*, ACBindings.Internal.UIElementMessageListenResult>)0x004C0710)(ref this, i_rMsg);

    /// <summary>
    /// <code>Offset: 0x004C0780
    /// void __cdecl gmIndicatorsUI::Register()</code>
    /// </summary>
    public static void Register() => ((delegate* unmanaged[Cdecl]<void>)0x004C0780)();
}
