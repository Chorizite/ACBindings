...
public unsafe struct IKeystoneControl
{
    ...
    public unsafe struct IKeystoneControl_vtbl
    {
        ...
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ACBindings.Internal.Region**, ACBindings.Internal.tagPOINT*, uint*, int> GetDimensions; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, int> GetTabStop; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, int> GetTabIndex; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ushort*, ushort*> GetAttribute; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ushort*, ushort*> GetDefaultAttribute; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ushort*> GetTagName; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ushort*, ushort*, int> SetAttribute; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ushort*, ushort*, int> SetDefaultAttribute; // function pointer
        public System.IntPtr GetNamesOfAttributes;
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ACBindings.Internal.IKeystoneDocument*, int> SetDocument; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ACBindings.Internal.IKeystoneWindow*, int> SetWindow; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ACBindings.Internal.IKeystoneWindow*> GetWindow; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ACBindings.Internal.IKeystoneResourceFont*> GetFont; // function pointer
        public static delegate* unmanaged[Thiscall]<ACBindings.Internal.IKeystoneControl*, ushort*> GetDirectory; // function pointer
