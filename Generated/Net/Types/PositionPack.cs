...
public unsafe struct PositionPack
{
    ...
    {
        // Members
        public delegate* unmanaged[Thiscall]<ACBindings.Internal.PositionPack*, void> PositionPack_dtor_0; // function pointer
        public fixed byte gap4[4];
        public delegate* unmanaged[Thiscall]<ACBindings.Internal.PositionPack*, uint> GetPackSize; // function pointer
        public delegate* unmanaged[Thiscall]<ACBindings.Internal.PositionPack*, void**, uint, uint> Pack; // function pointer
        public delegate* unmanaged[Thiscall]<ACBindings.Internal.PositionPack*, void**, uint, int> UnPack; // function pointer
