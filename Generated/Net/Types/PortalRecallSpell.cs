...
public unsafe struct PortalRecallSpell
{
    ...
    // Child Types
    // PortalRecallSpell_vtbl
    public unsafe struct PortalRecallSpell_vtbl
    {
        // Members
        public System.IntPtr PortalRecallSpell_dtor_0; // function pointer
    ...
    // Methods
    // void __thiscall PortalRecallSpell::SetEqual(PortalSendingSpell*,const Spell*,const Spell*)
    public void SetEqual(ACBindings.Spell* dst, ACBindings.Spell* src) => ((delegate* unmanaged[Thiscall]<ref ACBindings.PortalRecallSpell, ACBindings.Spell*, ACBindings.Spell*, void>)0x00599A40)(ref this, dst, src);
}
